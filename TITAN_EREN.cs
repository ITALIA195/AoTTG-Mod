...
public class TITAN_EREN : Photon.MonoBehaviour
{
    ...
    [RPC]
    private void playsoundRPC(string sndname) //BUG: http://prntscr.com/fig3ac
    {
        base.transform.Find(sndname)?.GetComponent<AudioSource>()?.Play();
    }

    [RPC]
    private void removeMe() //MOD: Interessante...
    {
    ...
    {
        this.loadskin();
        FengGameManagerMKII.instance.RegisterTitanEren(this);
        if (this.rockLift)
        {

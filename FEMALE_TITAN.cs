...
public class FEMALE_TITAN : Photon.MonoBehaviour
{
    ...
    private readonly float gravity = 120f;
    ...
    {
        if (grabTarget.GetComponent<HERO>() == Core.Hero && ModManager.Find("module.antigrab").Enabled)
            return;
        ...
        if (!this.hasDie && (this.state != "anklehurt"))
        {
            ...
            if (view != null)
            {
                ...
                if (vector.magnitude < 20f)
                {
                    ...
                    GameObject.Find("MultiplayerManager").GetComponent<FengGameManagerMKII>().sendKillInfo(false, (string) view.owner.Name, true, "Female Titan's ankle", dmg);
    ...
    {
        GameObject.Find("MultiplayerManager").GetComponent<FengGameManagerMKII>().RegisterFemaleTitan(this);
    ...
    public void titanGetHit(int viewID, int speed)
    {
        ...
        if (view != null)
        {
            ...
            if ((vector.magnitude < this.lagMax) && (this.healthTime <= 0f))
            {
                ...
                {
                    GameObject.Find("MultiplayerManager").GetComponent<FengGameManagerMKII>().sendKillInfo(false, (string) view.owner.Name, true, "Female Titan's neck", speed);

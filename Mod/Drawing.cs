...
namespace Mod
{
    public static class Drawing
    {
        ...
        {
            float raggio = (float)radius / 2;

            Vector2 p1 = new Vector2(center.x, center.y - radius);
            Vector2 p1_tan_a = new Vector2(center.x - raggio, center.y - radius);
            Vector2 p1_tan_b = new Vector2(center.x + raggio, center.y - radius);

            Vector2 p2 = new Vector2(center.x + radius, center.y);
            Vector2 p2_tan_a = new Vector2(center.x + radius, center.y - raggio);
            Vector2 p2_tan_b = new Vector2(center.x + radius, center.y + raggio);

            Vector2 p3 = new Vector2(center.x, center.y + radius);
            Vector2 p3_tan_a = new Vector2(center.x - raggio, center.y + radius);
            Vector2 p3_tan_b = new Vector2(center.x + raggio, center.y + radius);

            Vector2 p4 = new Vector2(center.x - radius, center.y);
            Vector2 p4_tan_a = new Vector2(center.x - radius, center.y - raggio);
            Vector2 p4_tan_b = new Vector2(center.x - radius, center.y + raggio);
